...
const SingleEntry: React.FC<EntryInputProps> = (props) => {
    ...
    return (
        <>
            <div className={styles.entry + " " + (props.width < 600 ? styles.narrowEntry : "")}>
                <div style={{
                    display: "flex",
                ...
                <div className={styles.inputs}>
                    <div className={styles.top}>
                        <div className={styles.both}>
                            <MyDatePicker date={props.entry.date}
                                          setDate={(date) => props.setEntry({...props.entry, date})}/>
                        </div>
                        <div className={styles.both}>
                            <FormControl variant={"filled"}>
                                <InputLabel>Beschreibung</InputLabel>
                                <FilledInput value={props.entry.description}
                                             onChange={(e) => props.setEntry({
                                                 ...props.entry,
                        ...
                        <div className={styles.both}>
                            <FormControl variant={"filled"}>
                                ...
                                <FilledInput value={props.entry.amount}
                                             onChange={(e) => props.setEntry({
                                                 ...props.entry,
                        ...
                        <div className={styles.both}>
                            <FormControl variant={"filled"}>
                                ...
                                <FilledInput value={Math.round(props.entry.brutto * (props.entry.vat / 100 + 1) * 100)/100}
                                             onChange={(e) => props.setEntry({
                                                 ...props.entry,
                                                 brutto: Math.round((Number(e.target.value) / (props.entry.vat / 100 + 1)) * 100) / 100
                                             })} type={"number"}/>
                            </FormControl>
                        </div>
                        <div className={styles.both}>
                            <FormControl variant={"filled"}>
                                ...
                                <FilledInput value={props.entry.brutto}
                                             onChange={(e) => props.setEntry({
                                                 ...props.entry,
                        ...
                        <div className={styles.both}>
                            <FormControl variant="filled">
                                ...
                                <Select
                                    ...
                                    onChange={(e) => props.setEntry({...props.entry, vat: Number(e.target.value)})}
                                >
