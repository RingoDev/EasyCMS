      ...
      <div style={{ padding: "2rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <FormControl variant={"filled"}>
            ...
            <FilledInput
              value={props.document.invoiceNr}
              onChange={(e) => {
                props.setDocument({
                  ...props.document,
          ...
          <MyDatePicker
            ...
            setDate={(date) => props.setDocument({ ...props.document, date })}
          />
          <FormControl variant={"filled"}>
            <InputLabel>Betreff</InputLabel>
            <FilledInput
              value={props.document.subject}
              onChange={(e) => {
                props.setDocument({
                  ...props.document,
        ...
        <Controls
          width={props.width}
          entries={props.document.entries}
          setEntries={handleChange}
        />
      </div>
    </>
  );
