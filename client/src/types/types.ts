...
enum Permissions {
    Admin = "Admin", User = "User", Public = "Public"
}

export enum ComponentTypes {
    Container = "Container", NumberInput = "NumberInput", SinglelineText = "SinglelineText", MultilineText = "MultilineText", Checkbox = "Checkbox"
}
